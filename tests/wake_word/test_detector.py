...
class TestContainsWakeWord:
    ...
    def test_returns_true_for_figaro(self) -> None:
        result = contains_wake_word("figaro what time is it")
        assert_that(result, is_(True))

    def test_returns_true_with_mixed_case(self) -> None:
        result = contains_wake_word("Figaro what is the weather")
        assert_that(result, is_(True))

    def test_returns_true_with_upper_case(self) -> None:
        result = contains_wake_word("FIGARO tell me a joke")
        assert_that(result, is_(True))
