...
1. **Custom wake word** - Blocked: openWakeWord training broken for Python 3.12+ (piper-phonemize has no wheels)
...
## Update: Radio Control Added

BBC Radio control is now working:
- "play radio 3", "play radio 4", "play news", "play world service"
- "stop" to stop playback
- Uses mpv for HLS streaming via lsn.lv proxy

New hexagonal architecture for radio module:
- `RadioPlayerPort` - abstract interface
- `BBCRadioPlayer` - mpv-based implementation
- `FakeRadioPlayer` - for testing
...
## Files Changed (Radio Control)

```
M  README.md
M  src/much_miller/main.py
M  docs/progress-2026-02-02.md
A  src/much_miller/radio/__init__.py
A  src/much_miller/radio/ports/__init__.py
A  src/much_miller/radio/ports/radio_player.py
A  src/much_miller/radio/adapters/__init__.py
A  src/much_miller/radio/adapters/bbc_radio_player.py
A  src/much_miller/radio/adapters/fake_radio_player.py
A  tests/radio/__init__.py
A  tests/radio/test_bbc_radio_player.py
```
